  ...
  return (
    <div className='py-5 sticky top'>
        <div className='relative flex items-center'>
            <input type="text" className='py-3 rounded-full teext-gray-500 w-full pl-12'/>
        ...
        <section className='mt-7 space-y-5 text-left'>
            ...
            {[1,1,1].map((items)=><div className='flex justify-between w-full'>
                <div>
